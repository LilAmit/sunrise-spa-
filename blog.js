...
if (chatbotBtn && chatbotContainer && chatbotClose && chatbotMessages) {
...
if (modal && modalBody && modalClose && readMoreBtns.length > 0) {
    // פתיחת מודאל
...
allFaders.forEach(f => fadeObserver.observe(f));
