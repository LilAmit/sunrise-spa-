...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const fullPosts = {
    ...
    wartime: {
      title: "למה עיסוי בתקופת מלחמה הוא לא מותרות – אלא הכרח",
      category: "בריאות ורווחה",
      date: "25 מרץ 2026",
      content: `
            <h3><i class="fa-solid fa-shield-heart"></i> הגוף במצב דריכות על</h3>
            <p>
                בתקופות של מתח ביטחוני ואי-ודאות, הגוף והנפש שלנו נמצאים במצב מתמיד של "דריכות על" (Hyper-arousal).
                סאנרייז ספא בפתח תקווה מציע מענה מדויק לצורך הזה, ויש לכך כמה סיבות משמעותיות.
            </p>

            <h3><i class="fa-solid fa-flask"></i> 1. הפחתת רמות הקורטיזול (הורמון הסטרס)</h3>
            <p>
                בזמן מלחמה, הגוף מפריש כמויות גבוהות של אדרנלין וקורטיזול. עיסוי מקצועי – בין אם מדובר בעיסוי שוודי
                מרגיע או בעיסוי תאילנדי מסורתי – מסייע בהורדה פיזית של רמות ההורמונים הללו, מה שמאפשר למערכת העצבים
                לעבור ממצב של "הילחם או ברח" למצב של שיקום ומנוחה.
            </p>

            <h3><i class="fa-solid fa-person-walking"></i> 2. שחרור "שרירי הסטרס"</h3>
            <p>
                מתח נפשי נוטה להצטבר באזורים ספציפיים בגוף: בכתפיים, בצוואר ובלסתות. חוסר המודעות לכיווץ השרירים
                לאורך זמן עלול להוביל לכאבי ראש ונוקשות כרונית. טיפול ממוקד בספא עוזר לשחרר את אותן חסימות פיזיות
                שנוצרות כתוצאה מהמצב.
            </p>

            <h3><i class="fa-solid fa-mobile-screen-button"></i> 3. ניתוק מהמסכים ומהחדשות</h3>
            <p>
                אחד היתרונות הגדולים ביותר בביקור בספא כיום הוא הדיגיטל דטוקס הכפוי. השעה שבה הטלפון נשאר בלוקר
                היא שעה של שקט מוחלט ממהדורות החדשות ומהתראות "צבע אדום", מה שמאפשר למוח מרחב נשימה חיוני
                לעיבוד המציאות.
            </p>

            <h3><i class="fa-solid fa-bed"></i> 4. שיפור איכות השינה</h3>
            <p>
                רבים חווים קשיי שינה בתקופות מלחמה. טיפולי ספא מעודדים הפרשת סרוטונין ודופמין, שתורמים לתחושת
                רווחה כללית (Well-being) ומסייעים להירדמות קלה יותר ולשינה עמוקה ואיכותית יותר, שהיא קריטית
                לתפקוד היומיומי.
            </p>
            ...
            <div class="benefits-grid">
                <div class="benefit-card">
                    ...
                    <h4>הפחתת קורטיזול</h4>
                    <p>הורדה פיזית של הורמוני הסטרס ומעבר למצב שיקום</p>
                </div>
                <div class="benefit-card">
                    <i class="fa-solid fa-unlock"></i>
                    <h4>שחרור שרירי סטרס</h4>
                    <p>טיפול ממוקד בכתפיים, צוואר ולסתות</p>
                </div>
                <div class="benefit-card">
                    <i class="fa-solid fa-mobile-screen-button"></i>
                    <h4>דיגיטל דטוקס</h4>
                    <p>ניתוק מהמסכים ומרחב נשימה מוחלט</p>
                </div>
                <div class="benefit-card">
                    <i class="fa-solid fa-moon"></i>
                    <h4>שינה איכותית</h4>
                    <p>שיפור השינה בזכות הפרשת סרוטונין ודופמין</p>
                </div>
            </div>

            <h3><i class="fa-solid fa-star"></i> סוגי טיפולים מומלצים לתקופה זו</h3>
            <ul>
                <li><strong>עיסוי רקמות עמוק</strong> - לשחרור עומס פיזי מצטבר</li>
                <li><strong>עיסוי תאילנדי</strong> - לשיפור הגמישות והזרמת אנרגיה מחודשת לגוף</li>
                <li><strong>טיפול באבנים חמות</strong> - מומלץ במיוחד להרגעה עמוקה של מערכת העצבים בזכות החום המלטף</li>
            </ul>
